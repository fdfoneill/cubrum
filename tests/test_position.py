...
class TestColumnPosition(unittest.TestCase):
    ...
    def testContainsPointDistantPoint(self):
        van_position = cubrum.position.PointPosition(("Ulgis", "Orbost"), orientation="Orbost", distanceToDestination=3, map=self.roads)
        rear_position = cubrum.position.PointPosition(("Ulgis", "Nabiac"), orientation="Ulgis", distanceToDestination=1, map=self.roads)
        ...
        outside_position = cubrum.position.PointPosition("Three Road Keep", map=self.roads)
        self.assertFalse(column_position.containsPoint(outside_position))
    
    def testContainsPointSharedEdgeOutsideRear(self):
        van_position = cubrum.position.PointPosition(("Ulgis", "Orbost"), orientation="Orbost", distanceToDestination=3, map=self.roads)
        rear_position = cubrum.position.PointPosition(("Ulgis", "Nabiac"), orientation="Ulgis", distanceToDestination=1, map=self.roads)
        column_position = cubrum.position.ColumnPosition(vanPosition=van_position, rearPosition=rear_position, waypoints=["Ulgis"], columnLength=10)
        outside_position = cubrum.position.PointPosition(("Ulgis", "Nabiac"), orientation="Ulgis", distanceToDestination=2, map=self.roads)
        self.assertFalse(column_position.containsPoint(outside_position))
        
    def testContainsPointSharedEdgeInsideRear(self):
        van_position = cubrum.position.PointPosition(("Ulgis", "Orbost"), orientation="Orbost", distanceToDestination=3, map=self.roads)
        rear_position = cubrum.position.PointPosition(("Ulgis", "Nabiac"), orientation="Ulgis", distanceToDestination=1, map=self.roads)
        column_position = cubrum.position.ColumnPosition(vanPosition=van_position, rearPosition=rear_position, waypoints=["Ulgis"], columnLength=10)
        outside_position = cubrum.position.PointPosition(("Ulgis", "Nabiac"), orientation="Ulgis", distanceToDestination=0.5, map=self.roads)
        self.assertTrue(column_position.containsPoint(outside_position))
        
    def testContainsPointSharedEdgeInsideRearShrinking(self):
        van_position = cubrum.position.PointPosition(("Ulgis", "Orbost"), orientation="Ulgis", distanceToDestination=3, map=self.roads)
        rear_position = cubrum.position.PointPosition(("Ulgis", "Nabiac"), orientation="Ulgis", distanceToDestination=1, map=self.roads)
        column_position = cubrum.position.ColumnPosition(vanPosition=van_position, rearPosition=rear_position, waypoints=["Ulgis"], columnLength=10)
        outside_position = cubrum.position.PointPosition(("Ulgis", "Orbost"), orientation="Ulgis", distanceToDestination=0.5, map=self.roads)
        self.assertTrue(column_position.containsPoint(outside_position))
        
    def testContainsPointSharedEdgeOutsideVan(self):
        van_position = cubrum.position.PointPosition(("Ulgis", "Orbost"), orientation="Orbost", distanceToDestination=3, map=self.roads)
        rear_position = cubrum.position.PointPosition(("Ulgis", "Nabiac"), orientation="Ulgis", distanceToDestination=1, map=self.roads)
        column_position = cubrum.position.ColumnPosition(vanPosition=van_position, rearPosition=rear_position, waypoints=["Ulgis"], columnLength=10)
        outside_position = cubrum.position.PointPosition(("Ulgis", "Orbost"), orientation="Ulgis", distanceToDestination=3, map=self.roads)
        self.assertFalse(column_position.containsPoint(outside_position))
        
    def testContainsPointSharedEdgeInsideVan(self):
        van_position = cubrum.position.PointPosition(("Ulgis", "Orbost"), orientation="Orbost", distanceToDestination=3, map=self.roads)
        rear_position = cubrum.position.PointPosition(("Ulgis", "Nabiac"), orientation="Ulgis", distanceToDestination=1, map=self.roads)
        column_position = cubrum.position.ColumnPosition(vanPosition=van_position, rearPosition=rear_position, waypoints=["Ulgis"], columnLength=10)
        outside_position = cubrum.position.PointPosition(("Ulgis", "Orbost"), orientation="Orbost", distanceToDestination=3.2, map=self.roads)
        self.assertTrue(column_position.containsPoint(outside_position))
        
    def testContainsPointSharedEdgeInsideVanShrinking(self):
        van_position = cubrum.position.PointPosition(("Ulgis", "Orbost"), orientation="Ulgis", distanceToDestination=3, map=self.roads)
        rear_position = cubrum.position.PointPosition(("Ulgis", "Nabiac"), orientation="Ulgis", distanceToDestination=1, map=self.roads)
        column_position = cubrum.position.ColumnPosition(vanPosition=van_position, rearPosition=rear_position, waypoints=["Ulgis"], columnLength=10)
        outside_position = cubrum.position.PointPosition(("Ulgis", "Orbost"), orientation="Ulgis", distanceToDestination=0.5, map=self.roads)
    ...
    def testContainsPointIsWaypoint(self):
        van_position = cubrum.position.PointPosition(("Ulgis", "Orbost"), orientation="Orbost", distanceToDestination=3, map=self.roads)
        rear_position = cubrum.position.PointPosition(("Ulgis", "Nabiac"), orientation="Ulgis", distanceToDestination=1, map=self.roads)
        column_position = cubrum.position.ColumnPosition(vanPosition=van_position, rearPosition=rear_position, waypoints=["Ulgis"], columnLength=10)
        outside_position = cubrum.position.PointPosition("Ulgis", map=self.roads)
        self.assertTrue(column_position.containsPoint(outside_position))
        
    def testContainsPointIsEndPoint(self):
        van_position = cubrum.position.PointPosition("Ulgis", map=self.roads)
        rear_position = cubrum.position.PointPosition(("Ulgis", "Nabiac"), orientation="Ulgis", distanceToDestination=1, map=self.roads)
        column_position = cubrum.position.ColumnPosition(vanPosition=van_position, rearPosition=rear_position, columnLength=10)
        outside_position = cubrum.position.PointPosition("Ulgis", map=self.roads)
        self.assertTrue(column_position.containsPoint(outside_position))
        
    def testContainsPointBetweenWaypoints(self):
        van_position = cubrum.position.PointPosition(("Nkaa","Ikachell"), orientation="Ikachell", distanceToDestination=8, map=self.roads)
        rear_position = cubrum.position.PointPosition(("Jomma Keep", "Sultan's Rock"), orientation="Sultan's Rock", distanceToDestination=1, map=self.roads)
